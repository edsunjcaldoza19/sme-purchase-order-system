                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="card border-primary mb-3">
                            <div class="card-content">
                                <?php
                                    $image = (!empty($fetch['product_image'])) ? 'images/product/'.$fetch['product_image'] : 'images/product/default-8-1-2021.jpg';
                                ?>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item bg-success text-white">Price: <?php echo $fetch['product_price']; ?></li>
